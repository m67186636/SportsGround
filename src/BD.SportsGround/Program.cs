...
public class Program
{
    public async static Task<int> Main(string[] args)
    {
        ...
        try
        {
            ...
            {
                services.AddHostedService<SportsGroundHostedService>();
                services.AddHostedService<DbGroundHostedService>();

                services.AddApplicationAsync<SportsGroundModule>(options =>
                {
